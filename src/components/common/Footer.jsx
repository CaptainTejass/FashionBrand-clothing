        ...
        <div className="flex flex-col lg:flex-row justify-between items-start mb-6 md:mb-8">
          ...
          <div className="flex flex-col sm:flex-row items-center sm:items-start space-y-6 sm:space-y-0 sm:space-x-6">
            ...
            <div className="flex space-x-4">
              <a
                href="https://www.instagram.com/captain_tejass/"
              ...
              <a
                href="https://www.linkedin.com/in/captaintejas/"
                className="text-white hover:text-gray-300"
                target="_blank"
              >
              ...
              <a
                href="https://github.com/CaptainTejass"
                className="text-white hover:text-gray-300"
                target="_blank"
              >
